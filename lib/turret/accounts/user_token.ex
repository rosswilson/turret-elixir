defmodule Turret.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Turret.Accounts.User
  ...
  def build_session_token(user) do
    ...
    {token, %Turret.Accounts.UserToken{token: token, context: "session", user_id: user.id}}
  end
  ...
  def token_and_context_query(token, context) do
    from Turret.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
  ...
  def user_and_contexts_query(user, :all) do
    from t in Turret.Accounts.UserToken, where: t.user_id == ^user.id
  end
